...
impl HTTP {
    pub fn description(&self) -> &'static str {
        match self {
            ...
            HTTP::MREGISTER_E_DEVICE_MESSAGE_FORMAT_ERROR => "Description is missing",
            ...
            HTTP::MREGISTER_E_DEVICE_AUTHORIZATION_ERROR => "Description is missing",
            HTTP::HTTP_E_STATUS_UNEXPECTED_CLIENT_ERROR => "Unexpected client error status code (4xx).",
            HTTP::MREGISTER_E_DEVICE_CERTIFCATEREQUEST_ERROR => "Description is missing",
            HTTP::HTTP_E_STATUS_UNEXPECTED_SERVER_ERROR => "Unexpected server error status code (5xx).",
            HTTP::MREGISTER_E_DEVICE_CONFIGMGRSERVER_ERROR => "Description is missing",
