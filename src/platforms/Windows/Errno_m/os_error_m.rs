...
impl OSError {
    ...
    pub fn error(&self) -> RawError {
        match self {
            OSError::ERROR_INVALID_FUNCTION => RawError::Kind(OSError::ERROR_INVALID_FUNCTION),
            OSError::ERROR_FILE_NOT_FOUND => RawError::Kind(OSError::ERROR_FILE_NOT_FOUND),
            OSError::ERROR_PATH_NOT_FOUND => RawError::Kind(OSError::ERROR_PATH_NOT_FOUND),
            OSError::ERROR_TOO_MANY_OPEN_FILES => RawError::Kind(OSError::ERROR_TOO_MANY_OPEN_FILES),
            OSError::ERROR_ACCESS_DENIED => RawError::Kind(OSError::ERROR_ACCESS_DENIED),
            OSError::ERROR_INVALID_HANDLE => RawError::Kind(OSError::ERROR_INVALID_HANDLE),
            OSError::ERROR_ARENA_TRASHED => RawError::Kind(OSError::ERROR_ARENA_TRASHED),
            OSError::ERROR_NOT_ENOUGH_MEMORY => RawError::Kind(OSError::ERROR_NOT_ENOUGH_MEMORY),
            OSError::ERROR_INVALID_BLOCK => RawError::Kind(OSError::ERROR_INVALID_BLOCK),
            OSError::ERROR_BAD_ENVIRONMENT => RawError::Kind(OSError::ERROR_BAD_ENVIRONMENT),
            OSError::ERROR_BAD_FORMAT => RawError::Kind(OSError::ERROR_BAD_FORMAT),
            OSError::ERROR_INVALID_ACCESS => RawError::Kind(OSError::ERROR_INVALID_ACCESS),
            OSError::ERROR_INVALID_DATA => RawError::Kind(OSError::ERROR_INVALID_DATA),
            OSError::ERROR_OUTOFMEMORY => RawError::Kind(OSError::ERROR_OUTOFMEMORY),
            OSError::ERROR_INVALID_DRIVE => RawError::Kind(OSError::ERROR_INVALID_DRIVE),
            OSError::ERROR_CURRENT_DIRECTORY => RawError::Kind(OSError::ERROR_CURRENT_DIRECTORY),
            OSError::ERROR_NOT_SAME_DEVICE => RawError::Kind(OSError::ERROR_NOT_SAME_DEVICE),
            OSError::ERROR_NO_MORE_FILES => RawError::Kind(OSError::ERROR_NO_MORE_FILES),
            OSError::ERROR_WRITE_PROTECT => RawError::Kind(OSError::ERROR_WRITE_PROTECT),
            OSError::ERROR_BAD_UNIT => RawError::Kind(OSError::ERROR_BAD_UNIT),
            OSError::ERROR_NOT_READY => RawError::Kind(OSError::ERROR_NOT_READY),
            OSError::ERROR_BAD_COMMAND => RawError::Kind(OSError::ERROR_BAD_COMMAND),
            OSError::ERROR_CRC => RawError::Kind(OSError::ERROR_CRC),
            OSError::ERROR_BAD_LENGTH => RawError::Kind(OSError::ERROR_BAD_LENGTH),
            OSError::ERROR_SEEK => RawError::Kind(OSError::ERROR_SEEK),
            OSError::ERROR_NOT_DOS_DISK => RawError::Kind(OSError::ERROR_NOT_DOS_DISK),
            OSError::ERROR_SECTOR_NOT_FOUND => RawError::Kind(OSError::ERROR_SECTOR_NOT_FOUND),
            OSError::ERROR_OUT_OF_PAPER => RawError::Kind(OSError::ERROR_OUT_OF_PAPER),
            OSError::ERROR_WRITE_FAULT => RawError::Kind(OSError::ERROR_WRITE_FAULT),
            OSError::ERROR_READ_FAULT => RawError::Kind(OSError::ERROR_READ_FAULT),
            OSError::ERROR_GEN_FAILURE => RawError::Kind(OSError::ERROR_GEN_FAILURE),
            OSError::ERROR_SHARING_VIOLATION => RawError::Kind(OSError::ERROR_SHARING_VIOLATION),
            OSError::ERROR_LOCK_VIOLATION => RawError::Kind(OSError::ERROR_LOCK_VIOLATION),
            OSError::ERROR_WRONG_DISK => RawError::Kind(OSError::ERROR_WRONG_DISK),
            OSError::ERROR_SHARING_BUFFER_EXCEEDED => RawError::Kind(OSError::ERROR_SHARING_BUFFER_EXCEEDED),
            OSError::ERROR_HANDLE_EOF => RawError::Kind(OSError::ERROR_HANDLE_EOF),
            OSError::ERROR_HANDLE_DISK_FULL => RawError::Kind(OSError::ERROR_HANDLE_DISK_FULL),
            OSError::ERROR_INVALID_PARAMETER => RawError::Kind(OSError::ERROR_INVALID_PARAMETER),
            OSError::ERROR_DISK_FULL => RawError::Kind(OSError::ERROR_DISK_FULL),
            OSError::ERROR_INVALID_NAME => RawError::Kind(OSError::ERROR_INVALID_NAME),
            OSError::ERROR_NO_SYSTEM_RESOURCES => RawError::Kind(OSError::ERROR_NO_SYSTEM_RESOURCES),
